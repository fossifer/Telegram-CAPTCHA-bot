{
    ...
    "yue": {
        // tbd
        "msg_self_introduction": "大家好，多謝使用呢隻機械人。\n\n我負責篩走啲廣告機械人，只要俾我 Ban users 嘅群管權限，我就會開始工作。如果唔想再用我，就撤銷我嘅權限啦。我會將啱啱入嚟嘅人禁言，然後出一條小學二年級嘅數學題，畀幾個選項佢揀。因為我係個仁慈嘅機械人，所以只要有㩒掣，我就會俾佢通過，甚至唔需要答啱條問題。\n\n我唔會收集群組內既訊息，原始碼已經公開咗喺GitHub，如果您對我嘅功能唔滿意，可以㩒我嘅頭像睇吓 bio 入面既link，修改同運行您自己嘅機械人。",
    ...
    "cdo": {
        ...
        "msg_challenge": "汝好，儂家開了驗證功能，請着 {timeout} 秒之內，篤下底其數字，完成驗證：\n{challenge}Nṳ̄ hō̤, nàng-gā kŭi lāu ngiêng-céng gŭng-nèng, chiāng diŏh {timeout} miēu cĭ-nó̤i, dók â-dā̤ gì só-cê, uòng-sìng ngiêng-céng:\n{challenge}\n\nHi! The group has enabled CAPTCHA, please click one of the buttons to answer the following question:\n{challenge}",
        "msg_challenge_passed": "汝已經通過驗證，歡迎加裡！\n汝㑚故是無辦法講話，關去 Telegram 客戶端再開起就會使。\n\nNṳ̄ ī-gĭng tŭng-guó ngiêng-céng, huăng-ngìng gă-diē! \nNṳ̄ nâ gó-sê mò̤ bâing-huák gōng-uâ, guŏng kó̤ Telegram káik-hô-duăng cái kŭi kī cêu â̤-sāi.\n\nWelcome to this group! You have passed the CAPTCHA. If you cannot send messages, please restart the Telegram client.",
        "msg_challenge_mercy_passed": "雖然汝答案有賺，儂家故是認爲汝正是儂無賺。歡迎加裡！\n汝㑚故是無辦法講話，關去 Telegram 客戶端再開起就會使。\n\nChŭi-iòng nṳ̄ dák-áng ô dâng, nàng-gă gó-sê nêng-ùi nṳ̄ ciáng-sê nè̤ng mò̤ dâng. Huăng-ngìng gă-diē! \nNṳ̄ nâ gó-sê mò̤ bâing-huák gōng-uâ, guŏng kó̤ Telegram káik-hô-duăng cái kŭi kī cêu â̤-sāi.\n\nWelcome to this group! You chose a wrong button but we still recognize you as a human.\nIf you cannot send messages, please restart the Telegram client.",
        "msg_challenge_failed": "儥好意思，汝無通過驗證。卜證明汝真其是儂，請發私訊乞管理員。\n\nMâ̤ hō̤ é-sé̤ṳ, nṳ̄ mò̤ tŭng-guó ngiêng-céng. Buóh céng-mìng nṳ̄ cĭng gì sê nè̤ng, chiāng huák sṳ̆-séng ké̤ṳk guāng-lī-uòng.\n\nSorry but you failed the CAPTCHA. Please contact group admins for help.",
